...
- Ajouter une fonction **"Se souvenir de moi"** qui stocke un cookie persistant.  
- Implémenter un **système de rôles (admin, utilisateur, etc.)**.  
- Ajouter une **fonction de récupération de mot de passe** avec un email.   -->
